...
#warning("unused")
//    /// Returns true if this delegate contains an authorization header.
//    public var hasAuthorizationHeader: Bool {
//        delegate?.headers["Authorization"] != nil
//    }
//
//    public func request<T: Decodable>(path: String, queryItems: [String: String]) -> Resource<T> {
//        Resource<T>(
//            additionalHeaders: MediaType.json.accept,
//            method: "GET",
//            path: path,
...
//    }
//
//    public func request(_ path: String) async throws -> Data {
//        let (data, _) = try await request(createRequest(path: path))
//        return data
//    }
//
//    func createRequest(path: String) throws -> URLRequest {
//        try URLRequest(url: createURL(path: path))
//    }
//
